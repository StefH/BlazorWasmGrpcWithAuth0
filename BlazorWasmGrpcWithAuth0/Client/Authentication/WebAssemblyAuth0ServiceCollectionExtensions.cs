...
namespace Microsoft.AspNetCore.Components.WebAssembly.Authentication
{
    public static class WebAssemblyAuth0ServiceCollectionExtensions
    {
        ...
        {
            services.TryAddEnumerable(ServiceDescriptor.Singleton<IPostConfigureOptions<RemoteAuthenticationOptions<Auth0ProviderOptions>>, DefaultAuth0OptionsConfiguration>());
