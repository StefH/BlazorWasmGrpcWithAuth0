...
{
    internal class DefaultAuth0OptionsConfiguration : IPostConfigureOptions<RemoteAuthenticationOptions<Auth0ProviderOptions>>
    {
        private readonly NavigationManager _navigationManager;

        public DefaultAuth0OptionsConfiguration(NavigationManager navigationManager) => _navigationManager = navigationManager;
